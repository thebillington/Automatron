...
<div id="instructions" style="position: absolute; text-align: center; padding: 100px; border: 10px solid black; background-color:white; width: 40%; height: 40%; top: 10%; overflow-y: scroll; visibility: hidden;">
	...
	<img src="/automatron/res/gifs/createWorker.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">

	<h3>Selecting a worker</h3>
	
	<p>To select a worker, click on the worker and they will highlight in red</p>
	
	<img src="/automatron/res/gifs/selectWorker.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	
	<h3>Deselecting a worker</h3>
	
	<p>To select a worker, click on the worker and they will return to their normal colour</p>
	
	<img src="/automatron/res/gifs/deselectWorker.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">

	<h3>Drawing a path</h3>
	
	<p>With a worker selected, click on the worker or adjacent to the worker to add to their path</p>
	
	<img src="/automatron/res/gifs/drawPath.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/running.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	
	<h3>Clearing the path</h3>
	
	<p>With a worker selected, press the c key to clear the path</p>
	
	<img src="/automatron/res/gifs/clear.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/reversed.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/looped.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/createLooper.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/movingPackage.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	
	<h3>Moving multiple Packets (packages)</h3>
	
	<p>It is possible to move more that one packet at once</p>
	
	<img src="/automatron/res/gifs/movingMultiPackage.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/packageToGoal.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/spawner.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/spawnFreq.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/crashWall.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	
	<h3>Automatrons crashing</h3>
	
	<p>The game will also crash if two automatrons occupy the same grid square on the same tick</p>
	
	<img src="/automatron/res/gifs/crashAutomatrons.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
	...
	<img src="/automatron/res/gifs/reset.gif" style="display: block; margin: 50px; max-width: 600px; width: 60%; height: auto; margin-left: auto; margin-right: auto;">
